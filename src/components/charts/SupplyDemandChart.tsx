...
import { supplyDemandBalance } from '../../data/mockData';

export function SupplyDemandChart() {
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={supplyDemandBalance} margin={{ top: 10, right: 20, bottom: 0, left: 0 }}>
        ...
        <Bar dataKey="cleared" name="清算成交量" fill="#7c3aed" radius={[3, 3, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
